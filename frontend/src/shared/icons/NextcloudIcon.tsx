...
// Official Nextcloud mark (simple-icons), recoloured to the Looka
// lavender used on the agent chips.
export function NextcloudIcon({ x, y, size = 16 }: AgentIconProps) {
  return (
    <svg x={x} y={y} width={size} height={size} viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet">
      <path
        fill="#473198"
