...
// SolidTime's "S" brand mark (solidtime/public/favicons/safari-pinned-tab.svg),
// recoloured. The group transform flips the original bottom-left origin.
export function SolidTimeIcon({ x, y, size = 16 }: AgentIconProps) {
  return (
    <svg x={x} y={y} width={size} height={size} viewBox="0 0 700 700" preserveAspectRatio="xMidYMid meet">
      <g transform="translate(0 700) scale(0.1 -0.1)" fill="#473198">
